...
function solve() {
	...
	return function (selector) {
		...
		'<a href="' +
			'{{#if this.url}}' +
				'{{this.url}}">See a {{this.name}}</a>' +
			'{{else}}' +
				'http://cdn.playbuzz.com/cdn/3170bee8-985c-47bc-bbb5-2bcb41e85fe9/d8aa4750-deef-44ac-83a1-f2b5e6ee029a.jpg">No link for {{this.name}} , here is Batman!' +
			'{{/if}}' +
		'</li>' +
		'{{/each}}' +
		'</ul>' +
